...
/**
 * 网易云 API 三种模式加密解密
 * 代码来源：https://github.com/jnwang95/music-java-api
 */
public class CryptoUtil {
     ...
     * @return
     */
    public static Map<String, String> getSecretData(ReqJsonObject reqJsonObject) {
        String[] encrypt = weapiEncrypt(reqJsonObject.toString());
